...
export function Menu() {
  ...
  const handleMenu12Click = () => {
    window.open('https://cnu.edu.cn', '_blank');
  };

  return (
    <div className="menu-container">
      <div className="menu-12" style={{ opacity: menu12 ? "0.9" : "0" }} onClick={handleMenu12Click}></div>
